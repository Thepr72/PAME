...
urlpatterns = [
    ...
    path('delete/<int:course>', views.DeleteCourses.as_view(), name='delete'),
    path('get/<int:course>', views.GetCourseDetails.as_view(), name='details'),
    path('get/all', views.GetallAvailableCourses.as_views(), name='get_all'),
    path('enroll/', views.GetAllAvailableCourse.as_view(), name='enroll'),
    path('post/new/', views.NewPost.as_views(), name='new_post'),
