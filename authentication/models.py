...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    first_name = models.CharField(
        _('Nombre(s)'), max_length=30, blank=True, null=True)
    last_name = models.CharField(
        _('Apellido(s)'), max_length=30, blank=True, null=True)
    ...
    Num = models.IntegerField( default=random.randint(10000,99999),)
